...
export const theme: MantineThemeOverride = {
	...
	colors: {
		primary: ['#CCE0FF', '#BAD0F3', '#9BACD9', '#5E77BC', '#4963AE', '#2F4070', '#232F53', '#1B2541', '#001A41', '#000000'],
		...
		shades: ['#FFFFFF', '#F0F0F0', '#E0E0E0', '#D0D0D0', '#C0C0C0', '#B0B0B0', '#A0A0A0', '#909090', '#808080', '#000000'],
		dark: [
			'#d5d7e0',
			'#acaebf',
			'#8c8fa3',
